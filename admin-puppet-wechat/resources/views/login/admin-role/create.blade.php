@extends('home.parent')
<?php 
$title = \App\Components\Tools::sLang('Add Role', '新增管理员角色');
?>
@section('title',$title)
@section('head_js')
@endsection
...
<section class="content-header">
    <h1>
        <?php echo \App\Components\Tools::sLang('Add Role', '新增管理员角色');?>
        <small></small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo \App\Components\Tools::sLang('Add Role', '新增管理员角色');?></li>
    </ol>
</section>
                ...
                <form role="form" action="{{URL('admin/role/create/save')}}" method="post" id="admin_role_create_form">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="role_name" name="role_name" placeholder="<?php echo \App\Components\Tools::sLang('Role name', '角色名');?>" required>
                        </div>
                        <div class="form-group">
