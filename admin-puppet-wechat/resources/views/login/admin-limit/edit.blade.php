@extends('home.parent')
<?php 
$title = \App\Components\Tools::sLang('Update Limit', '修改管理员权限信息');
?>
@section('title',$title)
@section('head_js')
@endsection
...
<section class="content-header">
    <h1>
        <?php echo \App\Components\Tools::sLang('Update Limit', '修改管理员权限信息');?>
        <small></small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo \App\Components\Tools::sLang('Update Limit', '修改管理员权限信息');?></li>
    </ol>
</section>
                ...
                <form role="form" action="{{URL('admin/limit/edit/save').'/'.$data['admin_limit_id'] }}" method="post" id="admin_limit_edit_form">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="limit_name" name="limit_name" value="{{ $data['limit_name'] }}" placeholder="<?php echo \App\Components\Tools::sLang('Limit name', '权限名');?>" required>
                        </div>
                        <div class="form-group">
                            <label for="limit_url"><?php echo \App\Components\Tools::sLang('Limit address', '权限地址');?></label>
                            <input type="text" class="form-control" id="limit_url" name="limit_url" value="{{ $data['limit_url'] }}" placeholder="<?php echo \App\Components\Tools::sLang('Limit address', '权限地址');?>" required>
                        </div>
                    </div>
                    <!-- /.box-body -->
