            ...
            <div class="box box-primary">
                ...
                <div class="box-body" style="min-height:500px;">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="keyword" name="keyword" placeholder="关键词" required>
                    </div>
                    <div class="form-group">
                        <label for="content">回复1</label>
