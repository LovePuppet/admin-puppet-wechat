@extends('home.parent')
<?php 
  $title = \App\Components\Tools::sLang('Update Channel', '修改渠道');
?>
@section('title',$title)
@section('head_js')
@endsection
...
<section class="content-header">
    <h1>
        <?php echo \App\Components\Tools::sLang('Update Channel', '修改渠道');?>
        <small></small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo \App\Components\Tools::sLang('Update Channel', '修改渠道');?></li>
    </ol>
</section>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                @endif
                <form role="form" action="{{URL('admin/channel/edit/save/'.$data['channel_id'])}}" method="post" id="data_form">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="channel_name"><?php echo \App\Components\Tools::sLang('Channel name', '渠道名称');?></label>
                            <input type="text" class="form-control" id="channel_name" name="channel_name" placeholder="<?php echo \App\Components\Tools::sLang('Channel name', '渠道名称');?>" value="{{ $data['channel_name'] }}" required>
                        </div>
                    </div>
                    <!-- /.box-body -->
...
$(document).ready(function(){
    $('#data_form').submit(function(){
        ...
        var data = {channel_name:channel_name,id:id};
