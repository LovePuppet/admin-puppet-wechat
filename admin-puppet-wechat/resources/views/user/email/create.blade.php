@extends('home.parent')
<?php 
  $title = \App\Components\Tools::sLang('Add Email', '新增邮箱');
?>
@section('title',$title)
@section('head_js')
@endsection
...
<section class="content-header">
  <h1>
    <?php echo \App\Components\Tools::sLang('Add Email', '新增邮箱');?>
    <small></small>
  </h1>
  <ol class="breadcrumb">
    ...
    <li class="active"><?php echo \App\Components\Tools::sLang('Add Email', '新增邮箱');?></li>
  </ol>
</section>
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="box box-primary">
        ...
        @endif
        <form role="form" action="{{URL('admin/email/create/save')}}" method="post" id="data_form">
          <div class="box-body">
            <div class="form-group">
              <label for="name"><?php echo \App\Components\Tools::sLang('Name', '名称');?></label>
              <input type="text" class="form-control" id="name" name="name" placeholder="<?php echo \App\Components\Tools::sLang('Name', '名称');?>">
            </div>
            <div class="form-group">
              <label for="name"><?php echo \App\Components\Tools::sLang('Email', '邮箱');?><span style="color: red">*</span></label>
              <input type="text" class="form-control" id="email" name="email" placeholder="<?php echo \App\Components\Tools::sLang('Email', '邮箱');?>" required>
            </div>
          </div>
          <!-- /.box-body -->
