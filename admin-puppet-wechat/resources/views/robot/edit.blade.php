@extends('home.parent')
<?php 
$title = \App\Components\Tools::sLang('Update rule', '修改规则');
?>
@section('title',$title)
@section('head_js')
@endsection
...
<section class="content-header">
    <h1>
        <?php echo \App\Components\Tools::sLang('Update rule', '修改规则');?>
        <small></small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo \App\Components\Tools::sLang('Update rule', '修改规则');?></li>
    </ol>
</section>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body" style="min-height:500px;">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="keyword" name="keyword" placeholder="<?php echo \App\Components\Tools::sLang('Key word', '关键词');?>" value="{{ $data['keyword'] }}" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <br><br>
                        <div id="show_material_4">@if(isset($content[3]['msgtype']) && $content[3]['content'])) {!! \App\Components\Tools::getMaterialHtml($content[3]['msgtype'],$content[3]['content']) !!} @endif</div>
                    </div>
                    <div class="form-group">
                        ...
                        <br><br>
                        <div id="show_material_5">@if(isset($content[4]['msgtype']) && $content[4]['content'])) {!! \App\Components\Tools::getMaterialHtml($content[4]['msgtype'],$content[4]['content']) !!} @endif</div>
                    </div>
                    <div class="form-group">
                        ...
                        <br><br>
                        <div id="show_material_6">@if(isset($content[5]['msgtype']) && $content[5]['content'])) {!! \App\Components\Tools::getMaterialHtml($content[5]['msgtype'],$content[5]['content']) !!} @endif</div>
                    </div>
                    <div class="form-group">
                        ...
                        <br><br>
                        <div id="show_material_7">@if(isset($content[6]['msgtype']) && $content[6]['content'])) {!! \App\Components\Tools::getMaterialHtml($content[6]['msgtype'],$content[6]['content']) !!} @endif</div>
                    </div>
                    <div class="form-group">
                        ...
                        <br><br>
                        <div id="show_material_8">@if(isset($content[7]['msgtype']) && $content[7]['content'])) {!! \App\Components\Tools::getMaterialHtml($content[7]['msgtype'],$content[7]['content']) !!} @endif</div>
                    </div>
                    <div class="form-group">
                        ...
                        <br><br>
                        <div id="show_material_9">@if(isset($content[8]['msgtype']) && $content[8]['content'])) {!! \App\Components\Tools::getMaterialHtml($content[8]['msgtype'],$content[8]['content']) !!} @endif</div>
                    </div>
                    <div class="form-group">
                        ...
                        <br><br>
                        <div id="show_material_10">@if(isset($content[9]['msgtype']) && $content[9]['content'])) {!! \App\Components\Tools::getMaterialHtml($content[9]['msgtype'],$content[9]['content']) !!} @endif</div>
                    </div>
                    <div class="form-group">
