...
<section class="content-header">
    <h1>
        <a href="{{URL('admin/wechat/follow/list')}}" class="btn btn-info"><?php echo \App\Components\Tools::sLang('New follower reply message setting', '新用户关注设置');?></a>
        <a href="{{URL('admin/wechat/follow/repeat')}}" class="btn btn-default"><?php echo \App\Components\Tools::sLang('Refollower reply message setting', '取关后重新关注设置');?></a>
    </h1>
    <ol class="breadcrumb">
...
function saveFollowData(){
    ...
    var url = "{{URL('admin/wechat/follow/new/save')}}";
