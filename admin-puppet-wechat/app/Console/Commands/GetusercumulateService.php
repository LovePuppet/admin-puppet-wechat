 ...
 * 获取累计用户数据
 */
class GetusercumulateService extends Command{
  /**
   * The name and signature of the console command.
   *
   * @var string
   */
  protected $signature = 'GetusercumulateService';
   ...
   * @var string
   */
  protected $description = '获取累计用户数据';
  ...
  public function getusercumulate() {
    ...
    $result = \App\Components\WxTools::getusercumulate($params);
